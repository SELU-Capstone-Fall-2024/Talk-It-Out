...
namespace TalkItOut.Migrations
{
    ...
    [Migration("20241205035304_AddSessionGoals")]
    partial class AddSessionGoals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TalkItOut.Entities.SessionGoals", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TalkItOut.Entities.Client", b =>
                {
                    b.HasOne("TalkItOut.Entities.Group", "Group")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("TalkItOut.Entities.SessionGoals", b =>
                {
                    b.HasOne("TalkItOut.Entities.Goal", "Goal")
                        .WithMany()
                        .HasForeignKey("GoalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TalkItOut.Entities.Session", "Session")
                        .WithMany()
